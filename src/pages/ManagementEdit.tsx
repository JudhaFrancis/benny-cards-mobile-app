...
const ManagementEdit: React.FC = () => {
  ...
  const cardOptionChoices = [
    ...
    "Buttersheet", "Tag", "Org. Ribbon", "Foiling", "Screen Printing", "UV", "Old Die", "New Die", 
    "Dry Flower", "Ready Seal", "Special Paper", "Custom Seal", "Pasting", "Others"
  ];
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      <CustomDropdown label="Order Placed In" id="placed_in" value={formData.order_details?.order_placed_in} options={['NGL', 'MTM', 'TVL', 'Chennai', 'Online']} onSelect={(val: string) => setFormData({...formData, order_details: {...formData.order_details, order_placed_in: val}})} />
                      <div className="input-group">
                        <label className="input-label">Reference Info</label>
                        <div className="input-field-wrapper"><IonInput value={formData.order_details?.reference} placeholder="e.g. Walk-In" onIonChange={e => setFormData({ ...formData, order_details: { ...formData.order_details, reference: e.detail.value! } })} className="custom-ion-input" /></div>
                      </div>
                      <div className="input-group">
                        <label className="input-label">Remarks</label>
                        <div className="input-field-wrapper"><IonTextarea value={formData.order_details?.remarks} placeholder="Enter remarks..." onIonChange={e => setFormData({ ...formData, order_details: { ...formData.order_details, remarks: e.detail.value! } })} className="custom-ion-input" /></div>
                      </div>
                    </div>
                  </div>
                </div>
